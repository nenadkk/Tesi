...
\newglossaryentry{PoC_ext}{
    ...
    text={PoC},
    sort={PoC},
    description={Proof of Concept, si tratta di un prodotto che ha lo scopo di dimostrare la fattibilità di un progetto andando ad implementare, e mettendo in relazione, diverse tecnologie e idee sulle quali esso si basa.
...
\newglossaryentry{can_ext}{
    ...
    text={CAN},
    sort={CAN},
    description={Protocollo di comunicazione seriale \textit{multi-master}, utilizzato per la comunicazione tra \textit{ECU (Electronic Control Units)} in ambito \textit{automotive}.
    Le varie \textit{ECU} sono collegate fisicamente tramite il \textit{CAN bus}, e comunicano mandano messaggi \textit{broadcast} nella rete condivisa}
}
