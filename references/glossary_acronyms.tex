...
\newglossaryentry{embedded_g}{
    ...
    text={embedded},
    sort={Embedded},
    description={Indica un sistema integrato hardware-software progettato per svolgere una funzione specifica e dedicata all'interno di un dispositivo. I sistemi \textit{embedded} operano tipicamente con risorse limitate (CPU, memoria, energia) e in ambiti come: centraline auto, elettrodomestici, dispositivi IoT, wearable e strumentazione medica}
}
