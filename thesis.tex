...
\begin{document}
    ...
    \mainmatter
    \input{chapters/1_il_contesto_aziendale.tex}
    \input{chapters/2_descrizione_del_tirocinio.tex}
    \input{chapters/3_lo_sviluppo_del_progetto.tex}
    \input{chapters/4_valutazione_retrospettiva.tex}
