...
Per \textit{embedded} si intendono sistemi elettronici, dalle risorse limitate (sia come memoria che come potenza di calcolo), d'uso comune in varie applicazioni che richiedono soluzioni, \textit{hardware} e \textit{software}, su misura, e che svolgano poche operazioni specifiche in modo efficiente.
Si integrano solitamente in sistemi più ampi e complessi, che possono coinvolgere sia altri dispositivi elettronici che componenti meccaniche in movimento, spesso con il compito di mettere in comunicazione altri dispositivi con il mondo esterno, ricevendo dati e mandando comandi.\\
\textit{Bluewind} si occupa sia dello sviluppo di prodotti \textit{software} per aziende nell'ambito industriale, medico e dell'\textit{automotive}, sia di fornire ad altre aziende servizi nell'ambito della sicurezza informatica e della \gls{func_saf_g} (quest'ultima verrà approfondita più nel dettaglio nel \hyperlink{ref:spiegazione_fun_saf}{terzo paragrafo} di questa sezione).\\\\
