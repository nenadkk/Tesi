...
Per \textit{embedded} si intendono sistemi integrati, dalle risorse limitate, d'uso comune in varie applicazioni che richiedono componenti specifiche e che svolgano poche operazioni in modo efficiente.\\
\textit{Bluewind} si occupa sia dello sviluppo di prodotti \textit{software} per aziende nell'ambito industriale, medico e dell'\textit{automotive}, sia di fornire ad altre aziende servizi nell'ambito della sicurezza informatica e della \gls{func_saf_g} (quest'ultima verrà approfondita in seguito).\\\\
\noindent
...
\noindent
\textit{GitLab} è una piattaforma che integra in un unico strumento la gestione del codice sorgente, il controllo di versione basato su \textit{Git}, l'integrazione e distribuzione continua (\gls{ci_cd}) con la possibilità di automatizzare l'avvio di una sequenza di test, e la gestione dei progetti.
