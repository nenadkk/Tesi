...
\noindent
Un approccio molto frequentemente adottato per la gestione di progetti e per lo sviluppo \textit{software} è il metodo \gls{agile_g}, basato su cicli iterativi e incrementali, che privilegia flessibilità, collaborazione, liente e adattamento al cambiamento rispetto alla pianificazione rigida.
